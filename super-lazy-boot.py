...
def generateProject():
    if not os.path.exists("src"):
        os.makedirs("src")
    if not os.path.exists("src/entity"):
        os.makedirs("src/entity")
    if not os.path.exists("src/service"):
        os.makedirs("src/service")
    if not os.path.exists("src/service/impl"):
        os.makedirs("src/service/impl")
    if not os.path.exists("src/repository"):
        os.makedirs("src/repository")
    if not os.path.exists("src/web"):
        os.makedirs("src/web")
    if not os.path.exists("src/web/dto"):
        os.makedirs("src/web/dto")
    if not os.path.exists("src/web/controller"):
        os.makedirs("src/web/controller")
    if not os.path.exists("src/web/mapper"):
        os.makedirs("src/web/mapper")
...
def generateEntities(className, attributes):
    ...
    javaEntity = open("src/entity/" + className + ".java", "w+")
...
def generateDtos(className, attributes):
    ...
    javaDto = open("src/web/dto/" + className + "DTO.java", "w+")
...
def generateRepositories(className, primaryKeyType):
    ...
    javaRepository = open("src/repository/" + className + "Repository.java", "w+")
...
def generateMapperInteface():
    ...
    mapperInterface = open("src/web/mapper/Mapper.java", "w+")
...
def generateMappers(className, attributes):
    ...
    mapperClass = open("src/web/mapper/" + className + "Mapper.java", "w+")
...
def generateServiceInterface(className, attributes):
    ...
    serviceInterface = open("src/service/" + className + "Service.java", "w+")
...
def generateServices(className, attributes):
    ...
    serviceClass = open("src/service/impl/" + className + "ServiceImpl.java", "w+")
...
def generateControllers(className, attributes):
    ...
    controllerClass = open("src/web/controller/" + className + "Controller.java", "w+")
...
def generateMain():
    ...
    for line in fileinput.input():
        ...
        generateEntities(data[0], attributes)
        generateRepositories(data[0], getPrimaryKeyType(attributes))
        generateDtos(data[0], attributes)
        generateMappers(data[0], attributes)
        generateServiceInterface(data[0], attributes)
        generateServices(data[0], attributes)
        generateControllers(data[0], attributes)
        print("")
        attributes = []
